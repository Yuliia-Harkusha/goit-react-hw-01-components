...
import { AiOutlineUsergroupAdd, AiOutlineEye, AiOutlineStar } from "react-icons/ai";
import { ProfileWrapper, Img, Description, UserName, UserInfo, Stats, ListItem, ListItemText, ListItemNumber } from './Profile.styled';

export const Profile = ({ username = " User name", tag, location = " User location", avatar, stats: { followers, views, likes } }) => {
